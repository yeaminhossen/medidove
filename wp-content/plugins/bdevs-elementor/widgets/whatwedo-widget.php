            ...
            <div class="container">
				...
				<?php foreach ( $settings['wedo_tabs'] as $item ) : ?>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12">
                        <div class="service-box service-box-2 bdevs-el-content mb-30 pos-rel">
                            ...
                            <div class="service-content service-content-2">
								...
								if (!empty($item['tab_sub_title'])) : ?>
									<h6 class="green-color  bdevs-el-subtitle text-up-case letter-spacing mb-20">
