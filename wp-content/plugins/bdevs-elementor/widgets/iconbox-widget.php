...
class BdevsIconbox extends \Elementor\Widget_Base {
    ...
    */
	...
	?>		
		...
		<div class="service-box bdevs-el-content icon-box text-center" style="background-image:url(<?php print esc_url($bg_image); ?>)">
            ...
            <div class="service-content">
                ...
                <h3 class="bdevs-el-title"><a <?php echo $this->get_render_attribute_string( 'heading_link' ); ?>><?php echo wp_kses_post($settings['heading']); ?></a></h3>
                <?php endif; ?>
